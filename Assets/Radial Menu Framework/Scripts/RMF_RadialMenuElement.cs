...
public class RMF_RadialMenuElement : MonoBehaviour {
    ...
    void Start () {
        ...
        rt.localRotation = Quaternion.Euler(rt.localRotation.eulerAngles.x, rt.localRotation.eulerAngles.y, -angleOffset); //Apply rotation determined by the parent radial menu.
    ...
    public void setParentMenuLable(string l) {
        ...
        if (parentRM.textLabel != null)
            parentRM.textLabel.text = l.Replace("\\n","\n"); ;
